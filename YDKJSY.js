...
refers to the entries in the outermost (the first level) array, and each
...
Note: There shouldn't be any spaces between the array name and the square
 brackets, like array [0][0] and even this array [0] [0] is not allowed. 
 Although JavaScript is able to process this correctly, this may confuse 
...
const myArray = [
  ...
  const myData = myArray[2][1]; //correct